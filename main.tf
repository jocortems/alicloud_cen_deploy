...
data "alicloud_cen_transit_router_route_table_associations" "global_transit_router_peering" {
  ...
  transit_router_route_table_id   = data.alicloud_cen_transit_router_route_tables.global_rts[0].transit_router_route_table_id[count_index]
}
...
data "alicloud_cen_transit_router_route_table_associations" "china_transit_router_peering" {
  ...
  transit_router_route_table_id   = data.alicloud_cen_transit_router_route_tables.china_rts[0].transit_router_route_table_id[count_index]
}
