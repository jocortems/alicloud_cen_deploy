...
resource "alicloud_vswitch" "global_slave" {
  ...
  zone_id      = var.cen_instance_id != null ? data.alicloud_cen_transit_router_available_resources.global_existing[0].resources[0].slave_zones[0] : data.alicloud_cen_transit_router_available_resources.global_new[0].resources[0].slave_zones[0]
}
...
resource "alicloud_cen_transit_router_vpc_attachment" "china" {
  ...
  zone_mappings {
    ...
    zone_id    = var.cen_instance_id != null ? data.alicloud_cen_transit_router_available_resources.china_existing[0].resources[0].slave_zones[0] : data.alicloud_cen_transit_router_available_resources.china_new[0].resources[0].slave_zones[0]
  }
}
...
resource "alicloud_cen_transit_router_route_table_association" "global_xregion_rtb_association" {  
  ...
  transit_router_route_table_id = alicloud_cen_transit_router_route_table.global_rtb.transit_router_route_table_id
  transit_router_attachment_id  = var.cen_instance_id != null ? local.global_transit_router_attachment[0] != null ? local.global_transit_router_attachment[0] : local.china_transit_router_attachment[0] : alicloud_cen_transit_router_peer_attachment.global_to_china.transit_router_attachment_id
}
...
resource "alicloud_route_entry" "global_to_china_new" {
  count                 = var.cen_instance_id != null ? 0 : 1
  provider              = alicloud.global
  depends_on            = [alicloud_cen_transit_router_peer_attachment.global_to_china]
...
resource "alicloud_route_entry" "global_to_china_existing" {
  count                 = var.cen_instance_id != null ? 1 : 0
  provider              = alicloud.global
  route_table_id        = data.alicloud_route_tables.global_transit_rtb.tables[0].route_table_id
  destination_cidrblock = var.china_vpc_cidr
...
resource "alicloud_route_entry" "china_to_global_new" {
  count                 = var.cen_instance_id != null ? 0 : 1
  provider              = alicloud.china
  depends_on            = [alicloud_cen_transit_router_peer_attachment.global_to_china]
...
resource "alicloud_route_entry" "china_to_global_existing" {
  count                 = var.cen_instance_id != null ? 1 : 0
  provider              = alicloud.china
  route_table_id        = data.alicloud_route_tables.china_transit_rtb.tables[0].route_table_id
  destination_cidrblock = var.global_vpc_cidr
